...
|---|---|---|---|---|---|---|---|
| XBI | Biotech (breadth 78%) | +9.43% | +6.12% | 109.0 | +6.64% | Leading | #1 |
| XLV | Health Care (breadth 78%) | +7.13% | +2.92% | 99.5 | +8.15% | Improving | #2 |
| XLE | Energy (breadth 62%) | +9.10% | +0.87% | 98.6 | +7.18% | Improving | #3 |
| SMH | Semiconductors | -11.56% | +20.23% | 112.9 | -17.20% | Weakening |  |
| XLF | Financials | +4.88% | +1.11% | 101.9 | +6.28% | Leading |  |
| XLK | Information Technology | -5.69% | +11.22% | 107.4 | -8.04% | Weakening |  |
| IGV | Software | +2.81% | +0.51% | 98.5 | +7.06% | Improving |  |
| XLRE | Real Estate | +3.56% | -3.90% | 99.2 | +3.14% | Improving |  |
| XLP | Consumer Staples | +1.47% | -3.05% | 94.8 | +1.61% | Improving |  |
| XLI | Industrials | -1.11% | -2.77% | 98.0 | -1.91% | Lagging |  |
| XLU | Utilities | +0.65% | -7.18% | 94.0 | +0.85% | Improving |  |
| XLY | Consumer Discretionary | -2.04% | -9.91% | 93.3 | +0.11% | Improving |  |
| XLC | Communication Services | +0.71% | -12.85% | 91.1 | +3.12% | Improving |  |
| XLB | Materials | -2.88% | -9.31% | 93.3 | -3.01% | Lagging |  |
| AI_INFRA | AI Infrastructure (breadth 33%) | -4.44% | +0.64% | 104.1 | -8.25% | Weakening | #4 |

## ③ Ranked ideas (2)

### 1. VRTX — Pullback to value (score 17.2)
...
### 2. GEV — Pullback to value (score 10.8)

GE Vernova — pullback to value in AI Infrastructure (sector rank #4), relative strength top 77% of candidates, flow neutral.

- **Entry:** 1082.4 (At market (price already inside ±1% of POC))
- **Stop:** 940.95 (below anchored VWAP, 13.1% risk)
- **Target:** 1482.67 (measured move (value-area width projected))
- **R:R:** 2.83  |  **Free-flow (+1R):** 1223.84
- **Risks:**
  ...
  - (medium) Wide structural stop (13.1% below entry) — halve position size so dollar risk stays constant.
...
- **OODA (AI-infrastructure theme):**
  - *Observe:*
    - Profitable today: trailing 12m EPS 34.22, net margin 24%
    - Real demand: quarterly revenue growing +16% YoY
    - Earnings growing +1816% YoY (forward estimates unavailable)
    - Price structure: pullback to value, flow neutral, +15.0% vs anchored VWAP.
...
- MPC (Energy, score 80.0): acceptance breakout but R:R 1.41 below 2.5 floor
- PSX (Energy, score 80.0): acceptance breakout but R:R 1.33 below 2.5 floor
- FANG (Energy, score 79.1): pullback to value but R:R 1.6 below 2.5 floor
- CAH (Health Care, score 65.4): pullback to value but R:R 1.32 below 2.5 floor
...
- CVS (Health Care, score 40.0): breakout extended (31 sessions above VAH)
...
- ELV (Health Care, score 40.0): pullback to value but R:R 1.11 below 2.5 floor
- INCY (Health Care, score 40.0): breakout extended (19 sessions above VAH)
- VTRS (Health Care, score 40.0): pullback to value but R:R 2.01 below 2.5 floor
