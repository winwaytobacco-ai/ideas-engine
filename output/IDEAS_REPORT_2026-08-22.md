...
|---|---|---|---|
| Credit stress (HY OAS) | 2.75% | < 21d MA (2.76) and < p75 of 252d (2.95) | PASS |
| Yield curve (10y-2y) | +0.50% (positive, steepening) | informational only in v1 | — |
| Volatility (VIX) | 16.0 | < 22 and < 50d MA (16.7) | PASS |
| Financial conditions (NFCI) | -0.56 | < 0.0 (loose) | PASS |
| SPY trend | 766 vs 200DMA 705 | Close > 200DMA, 50DMA > 200DMA, 200DMA slope up over 21d | PASS |
...
|---|---|---|---|---|---|---|---|
| XBI | Biotech (breadth 80%) | +5.14% | +21.58% | 112.3 | +3.04% | Leading | #1 |
| IGV | Software (breadth 47%) | +14.95% | +8.43% | 108.3 | +13.93% | Leading | #2 |
| XLV | Health Care (breadth 80%) | +4.43% | +15.02% | 107.0 | +4.83% | Leading | #3 |
| XLE | Energy | +3.44% | +5.04% | 104.0 | +2.47% | Leading |  |
| XLF | Financials | -0.78% | +8.14% | 102.3 | -0.46% | Weakening |  |
| XLB | Materials | +2.73% | +4.08% | 98.6 | +4.04% | Improving |  |
| XLY | Consumer Discretionary | +4.78% | -3.74% | 96.0 | +6.83% | Improving |  |
| XLP | Consumer Staples | -0.39% | -1.09% | 96.3 | +1.26% | Improving |  |
| XLK | Information Technology (breadth 47%) | -1.01% | -0.60% | 103.8 | -3.26% | Weakening |  |
| XLI | Industrials | -4.66% | +2.60% | 96.9 | -4.08% | Lagging |  |
| XLRE | Real Estate | -3.44% | -1.17% | 97.1 | -3.02% | Lagging |  |
| XLC | Communication Services | +1.98% | -7.16% | 92.6 | +4.54% | Improving |  |
| SMH | Semiconductors (breadth 47%) | -7.13% | -4.68% | 101.6 | -10.08% | Weakening |  |
| XLU | Utilities | -11.13% | -7.71% | 88.8 | -9.47% | Lagging |  |
| AI_INFRA | AI Infrastructure (breadth 47%) | -8.27% | -2.74% | 96.7 | -10.22% | Lagging | #4 |

## ③ Ranked ideas (2)

### 1. TECH — Pullback to value (score 35.5)
...
- **Stop:** 66.31 (below anchored VWAP, 6.8% risk)
- **Target:** 91.5 (measured move (value-area width projected))
- **R:R:** 4.21  |  **Free-flow (+1R):** 75.98
- **Risks:**
  ...
  - (info) Stop sits 6.8% below entry (~17.3 ATR), below anchored VWAP.
...
### 2. APH — Pullback to value (score 32.2)

Amphenol — pullback to value in Information Technology (sector rank #2), relative strength top 50% of candidates, flow neutral.

- **Entry:** 157.01 (At market (price at high-volume node))
- **Stop:** 150.95 (below anchored VWAP (widened to 1 ATR), 3.9% risk)
- **Target:** 176.32 (52-week high)
- **R:R:** 3.19  |  **Free-flow (+1R):** 163.07
- **Risks:**
  - (info) No flow confirmation yet (daily close-vs-open volume proxy is flat).
  - (info) Stop sits 3.9% below entry (~1.0 ATR), below anchored VWAP (widened to 1 ATR).

## ④ Appendix

**Watch — no valid trade yet:**

- CRWD (Information Technology, score 80.0): pullback to value but R:R 0.64 below 2.5 floor
- CNC (Health Care, score 80.0): pullback to value but R:R 0.44 below 2.5 floor
- ASML (Information Technology, score 80.0): pullback to value but R:R 1.33 below 2.5 floor
- WST (Health Care, score 58.9): pullback to value but R:R 0.28 below 2.5 floor
- EW (Health Care, score 48.3): breakout extended (15 sessions above VAH)
- CRL (Health Care, score 40.0): breakout extended (22 sessions above VAH)
- NTAP (Information Technology, score 40.0): breakout extended (20 sessions above VAH)
- IQV (Health Care, score 40.0): breakout extended (41 sessions above VAH)
- ZBRA (Information Technology, score 40.0): breakout extended (19 sessions above VAH)
- PANW (Information Technology, score 40.0): breakout extended (40 sessions above VAH)
- TMO (Health Care, score 40.0): breakout extended (22 sessions above VAH)
- A (Health Care, score 40.0): breakout extended (22 sessions above VAH)
...
- LH (Health Care, score 40.0): breakout extended (22 sessions above VAH)
- AMGN (Health Care, score 40.0): breakout extended (22 sessions above VAH)
- RVTY (Health Care, score 40.0): no qualifying structure yet
- DXCM (Health Care, score 40.0): breakout extended (16 sessions above VAH)
- DGX (Health Care, score 40.0): breakout extended (23 sessions above VAH)
...
- BMY (Health Care, score 40.0): breakout extended (24 sessions above VAH)
- ETN (AI Infrastructure, score 40.0): pullback to value but R:R 1.95 below 2.5 floor
- GEN (Information Technology, score 39.6): breakout extended (37 sessions above VAH)
- ZBH (Health Care, score 37.2): breakout extended (19 sessions above VAH)
- BAX (Health Care, score 20.0): breakout extended (42 sessions above VAH)
- INCY (Health Care, score 20.0): breakout extended (29 sessions above VAH)
- HUM (Health Care, score 20.0): no qualifying structure yet
- FTNT (Information Technology, score 20.0): breakout extended (41 sessions above VAH)
- TDY (Information Technology, score 20.0): below anchored VWAP
- CAH (Health Care, score 7.0): no qualifying structure yet
...
- HPQ (Information Technology, score 0.0): breakout extended (21 sessions above VAH)
...
- SOLV (Health Care, score 0.0): breakout extended (19 sessions above VAH)
