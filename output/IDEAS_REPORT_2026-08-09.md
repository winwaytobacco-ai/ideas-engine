...
| AI_INFRA | AI Infrastructure (breadth 47%) | -5.72% | -1.01% | 100.2 | -8.95% | Weakening | #4 |
...
- **OODA (AI-infrastructure theme):**
  - *Observe:*
    ...
    - Order-book proxy: forward EPS 5.14 above trailing 3.15 — analysts see the pipeline growing
    - Price structure: acceptance breakout above value, flow confirming, +17.2% vs anchored VWAP.
    - Order-book data is not in free feeds — forward-vs-trailing EPS is the proxy.
  - *Orient:*
    - AI-infrastructure basket is Weakening vs SPY (RS-ratio 100.2, momentum -8.9%), included by config policy 'always'.
...
- **R:R:** 4.01  |  **Free-flow (+1R):** 76.09
- **Risks:**
  - (medium) Trading 10% above anchored VWAP — mildly extended; prefer limit fills over market entries.
  - (high) Volume-flow divergence: price made new highs that the flow line did not confirm — demand may be thinning.
  - (info) Stop sits 7.3% below entry (~17.3 ATR), below anchored VWAP.
  - (medium) At 52-week highs: target is a measured-move projection with no overhead volume reference — take partial profits mechanically.

### 5. CAH — Pullback to value (score 27.9)
...
- **Stop:** 220.38 (below anchored VWAP, 6.8% risk)
- **Target:** 285.05 (measured move (value-area width projected))
- **R:R:** 3.04  |  **Free-flow (+1R):** 252.42
- **Risks:**
  - (medium) Trading 7% above anchored VWAP — mildly extended; prefer limit fills over market entries.
  - (high) Volume-flow divergence: price made new highs that the flow line did not confirm — demand may be thinning.
  - (info) Stop sits 6.8% below entry (~2.9 ATR), below anchored VWAP.
  - (medium) At 52-week highs: target is a measured-move projection with no overhead volume reference — take partial profits mechanically.

### 6. PFG — Pullback to value (score 22.4)
...
- **Stop:** 262.6 (below anchored VWAP, 10.9% risk)
- **Target:** 375.45 (measured move (value-area width projected))
- **R:R:** 2.53  |  **Free-flow (+1R):** 326.52
- **Risks:**
...
- CB (Financials, score 90.1): pullback to value but R:R 1.55 below 2.5 floor
- L (Financials, score 87.3): pullback to value but R:R 1.14 below 2.5 floor
...
- CPAY (Financials, score 80.0): acceptance breakout but R:R 1.28 below 2.5 floor
- PRU (Financials, score 80.0): pullback to value but R:R 0.81 below 2.5 floor
- ABBV (Health Care, score 80.0): pullback to value but R:R 1.31 below 2.5 floor
- GL (Financials, score 80.0): pullback to value but R:R 1.9 below 2.5 floor
- VRTX (Health Care, score 80.0): pullback to value but R:R 1.19 below 2.5 floor
- SOLV (Health Care, score 80.0): acceptance breakout but R:R 0.72 below 2.5 floor
...
- TDY (Information Technology, score 80.0): acceptance breakout but R:R 1.7 below 2.5 floor
- AAPL (Information Technology, score 80.0): pullback to value but R:R 1.51 below 2.5 floor
- HIG (Financials, score 80.0): acceptance breakout but R:R 1.65 below 2.5 floor
...
- LLY (Health Care, score 77.3): acceptance breakout but R:R 1.75 below 2.5 floor
...
- ELV (Health Care, score 60.0): pullback to value but R:R 1.36 below 2.5 floor
...
- FTNT (Information Technology, score 40.0): pullback to value but R:R 1.72 below 2.5 floor
...
- WFC (Financials, score 40.0): pullback to value but R:R 1.7 below 2.5 floor
...
- MET (Financials, score 38.6): breakout extended (27 sessions above VAH)
